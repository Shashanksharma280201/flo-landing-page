...
function CardInner({
  ...
  return (
    <div className="group relative aspect-video w-full overflow-hidden rounded-xl bg-gray-100 shadow-2xl">
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 bg-gradient-to-t from-white/95 via-white/55 to-transparent px-5 pt-12 pb-4 sm:px-7 sm:pt-14 sm:pb-5">
        <p
          className="text-sm leading-relaxed font-semibold text-[#5ba83d] sm:text-base"
