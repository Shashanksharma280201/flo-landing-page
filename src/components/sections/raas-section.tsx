  ...
  return (
    <section id="raas" className="relative z-10 overflow-hidden bg-white">
      <div className="relative bg-white py-12 sm:py-16 md:py-20 lg:py-28">
        <div className="absolute left-0 top-0 h-64 w-64 sm:h-80 sm:w-80 lg:h-96 lg:w-96 rounded-full bg-[#7ccd54]/10 blur-3xl" />
        <div className="absolute bottom-0 right-0 h-64 w-64 sm:h-80 sm:w-80 lg:h-96 lg:w-96 rounded-full bg-[#1a3a1f]/8 blur-3xl" />
        <div className="relative z-10 text-center px-4 sm:px-8 md:px-12 lg:px-16">
          <h2
            className="mb-4 sm:mb-6 font-bold leading-[1.15] tracking-tight text-gray-900"
            style={{
      ...
      <div ref={product1Ref} className="relative w-full bg-white max-w-full">
        <div className="grid lg:grid-cols-2 min-h-[500px] sm:min-h-[600px] lg:min-h-[800px]">
          {/* Left - Video */}
          <motion.div
            className="relative bg-black order-1 lg:order-1 min-h-[300px] sm:min-h-[400px] lg:min-h-full"
          ...
          {/* Right - Content */}
          <div className="relative bg-white flex items-center order-2 lg:order-2">
            <motion.div
              className="w-full px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-12 sm:py-16 lg:py-20"
              initial={{ opacity: 0, x: 100 }}
              animate={
                product1Visible ? { opacity: 1, x: 0 } : { opacity: 0, x: 100 }
              }
            ...
            >
              <h3
                className="mb-4 sm:mb-5 font-bold leading-[1.2] tracking-tight text-gray-900"
                style={{
                  fontFamily: "var(--font-dm-sans)",
              ...
              <p className="mb-6 sm:mb-8 max-w-xl text-[clamp(0.875rem,0.4vw+0.85rem,1.1rem)] leading-relaxed text-gray-600">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full bg-primary px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold text-white uppercase tracking-wide transition-all duration-300 hover:bg-primary/90 hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Explore Solution
      ...
      <div ref={product2Ref} className="relative w-full bg-white max-w-full">
        <div className="grid lg:grid-cols-2 min-h-[500px] sm:min-h-[600px] lg:min-h-[800px]">
          {/* Left - Content */}
          ...
          {/* Right - YouTube Video */}
          <motion.div
            className="relative order-1 lg:order-2 bg-black min-h-[300px] sm:min-h-[400px] lg:min-h-full"
            initial={{ opacity: 0, x: 100 }}
            animate={
              product2Visible ? { opacity: 1, x: 0 } : { opacity: 0, x: 100 }
            }
