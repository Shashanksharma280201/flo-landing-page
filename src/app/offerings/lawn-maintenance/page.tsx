        ...
        <FadeUp delay={0.15} className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                <div className="text-sm font-black" style={{ color: TEXT, fontFamily: "var(--font-dm-sans)" }}>Zero-Turn Radius</div>
                <div className="text-[11px] mt-0.5" style={{ color: MUTED }}>Precision corner handling</div>
              </div>
            </div>
            <div
              className="rounded-xl border p-6 flex flex-col justify-between"
            ...
            >
              ...
              <div>
                <div className="text-sm font-black" style={{ color: TEXT, fontFamily: "var(--font-dm-sans)" }}>Electric Drive</div>
                <div className="text-[11px] mt-0.5" style={{ color: MUTED }}>Zero emissions, all day</div>
              </div>
            </div>
          </div>
        </FadeUp>
